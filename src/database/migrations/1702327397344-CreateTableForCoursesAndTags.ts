...
export class CreateTableForCoursesAndTags1702327397344 implements MigrationInterface {
    name = 'CreateTableForCoursesAndTags1702327397344'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tags" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" text NOT NULL, CONSTRAINT "PK_e7dc17249a1148a1970748eda99" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "courses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "description" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "courses_tags_tags" ("coursesId" uuid NOT NULL, "tagsId" uuid NOT NULL, CONSTRAINT "PK_002f62ec2f0a22dc90ee3f25d4b" PRIMARY KEY ("coursesId", "tagsId"))`);
